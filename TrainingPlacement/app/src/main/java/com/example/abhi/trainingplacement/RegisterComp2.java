...
public class RegisterComp2 extends AppCompatActivity {
    private static final int CODE_GET_REQUEST = 1024;
    private static final int CODE_POST_REQUEST = 1025;

    private RegisteredCompAdap2 mAdapter;
    ...
    protected  int stdgpa,stdtwe,stdtenth;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_register_comp2);
        mInflater = LayoutInflater.from(this);
        mRecyclerView = (RecyclerView) findViewById(R.id.my_recycler_view2);
        mRecyclerView.setHasFixedSize(true);
        mLayoutManager = new GridLayoutManager(RegisterComp2.this,1);
    ...
    private void operation(JSONArray companies)throws JSONException {
        ...
        try {
            ...
            mAdapter = new RegisteredCompAdap2(RegisterComp2.this,com);
            mRecyclerView.setAdapter(mAdapter);
        }catch (JSONException e)
        {
            Log.v("JSON Exception:  ",e.getMessage());
            Toast.makeText(RegisterComp2.this,"Something Went Wrong,Please Contact to Developer/Admin",Toast.LENGTH_LONG).show();
