...
public class StudentList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLayoutManager = new GridLayoutManager(StudentList.this,1);
    ...
    public void getStudents() {
        PerformNetworkRequest request = new PerformNetworkRequest(Api.URL_READ_STUDENT , null, CODE_GET_REQUEST);
        request.execute();
    }
    ...
    private void operation(JSONArray companies)throws JSONException {
        ...
        try {
            ...
            mAdapter = new StudentListAdapt(StudentList.this,com);
            mRecyclerView.setAdapter(mAdapter);
        }catch (JSONException e)
        {
            Log.v("JSON Exception:  ",e.getMessage());
            Toast.makeText(StudentList.this,"Something Went Wrong,Please Contact to Developer/Admin",Toast.LENGTH_LONG).show();
